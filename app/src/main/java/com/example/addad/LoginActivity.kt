...
class LoginActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btn_guestLogin = findViewById<LinearLayout>(R.id.guest_login) as Button;
        var btn_googleSignIn = findViewById<LinearLayout>(R.id.btn_googleSignIn) as SignInButton;
        //btn_googleSignIn.setOnClickListener (this) // 구글 로그인 버튼
        btn_googleSignIn.setOnClickListener {signIn()}
        btn_guestLogin.setOnClickListener {toMainActivity2()}
